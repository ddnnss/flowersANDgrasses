...
def about_us(request):
    title = 'О НАС'
    show_tags = True
    return render(request, 'page/new/about.html', locals())
...
def category(request, cat_slug):
    try:
        ...
        all_items = Item.objects.filter(category_id=category.id, is_active=True, is_present=True).order_by('-created_at')
    ...
    return render(request, 'page/new/category.html', locals())
